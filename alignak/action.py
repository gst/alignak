...
if os.name == 'nt':
    from .action_win import _Action
else:
    from .action_linux import _Action
...
class Action(_Action):
    ...
    def __init__(self, command=None, timeout=10, env=None):
        if env is None:
            env = {}
    ...
    def execute(self):
        ...
        return super(Action, self).execute()  # OS specific part
