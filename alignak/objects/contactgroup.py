...
class Contactgroup(Itemgroup):
    ...
    def get_contactgroup_members(self):
        ...
        :rtype: list
        """
        # TODO: imho a Contactgroup instance should always have defined its contactgroup_members attribute,
        # even if it's empty / the empty list.
        if hasattr(self, 'contactgroup_members'):
            # TODO: more over: it should already be in the list form, not anymore in the "bare" string from as readed
