...
class Hostgroup(Itemgroup):
    ...
    def get_hostgroup_members(self):
        ...
        :rtype: list
        """
        # TODO: consistency : a Hostgroup instance should always have its hostgroup_members attribute defined,
        # even if the empty list
        if hasattr(self, 'hostgroup_members'):
            # TODO: consistency: any Hostgroup instance's hostgroup_members attribute should already be decoded/parsed:
            # this is it should already be in its list form.
