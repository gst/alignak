...
class TestConfig(ShinkenTest):
    ...
    def test_bad_template_use_itself(self):
        ...
        self.assertIn("Host u'bla' use/inherits from itself ! Imported from: etc/bad_template_use_itself.cfg:1",
    ...
    def test_bad_host_use_undefined_template(self):
        ...
        self.assertIn("Host u'bla' use/inherit from an unknown template (u'undefined') ! Imported from: etc/bad_host_use_undefined_template.cfg:2",
