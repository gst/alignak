...
class TestTriggers(ShinkenTest):
    ...
    def test_morecomplex_cpu_too_high(self):
        ...
        firstlen = len([b for b in list(self.sched.broks.values()) if b.type == 'service_check_result'])
        self.scheduler_loop(1, [(svc, 0, 'I am OK | cpu=95%')])
        seclen = len([b for b in list(self.sched.broks.values()) if b.type == 'service_check_result'])
